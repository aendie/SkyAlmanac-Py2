...
''' %(date.strftime("%a"))
        ...
        if config.decf != '+':	# USNO format for Declination
            ...
            while h < 24:
                line = "%s & %s & %s & %s & %s & %s & %s & %s & %s & %s" %(h,aGHA[h],vGHA[h],vDEC[h],mGHA[h],mDEC[h],jGHA[h],jDEC[h],sGHA[h],sDEC[h])
                lineterminator = "\\\ \n"
                if h < 23 and (h+1)%6 == 0:
                    lineterminator = "\\\[2Pt] \n"
                tab = tab + line + lineterminator
...
''' %(date.strftime("%a"))
        ...
        if config.decf != '+':	# USNO format for Declination
            ...
            while h < 24:
                ...
                line = "%s & %s & %s & %s & %s & %s & %s & %s" %(h,ghas[h],sdec,gham[h],vmin[h],mdec,dmin[h],HPm[h])
                lineterminator = "\\\ \n"
                if h < 23 and (h+1)%6 == 0:
                    lineterminator = "\\\[2Pt] \n"
                tab = tab + line + lineterminator
            ...
            while h < 24:
                line = "%s & %s & %s & %s & %s & %s & %s & %s" %(h,ghas[h],decs[h],gham[h],vmin[h],decm[h],dmin[h],HPm[h])
                lineterminator = "\\\ \n"
                if h < 23 and (h+1)%6 == 0:
                    lineterminator = "\\\[2Pt] \n"
                tab = tab + line + lineterminator
